...
class FriendTodoScreen extends StatelessWidget {
  // Declare a field that holds the Todo
  final int id;
  // In the constructor, require a Todo
  FriendTodoScreen({Key key, @required this.id}) : super(key: key);
          ...
          return new Card(
            child: InkWell(
              ...
              children: <Widget>[
                ...
                Text(
                  isCompleted(values[index].completed),
